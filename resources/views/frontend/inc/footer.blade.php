        ...
        <div class="row">
                            ...
                            @foreach (json_decode(get_setting('widget_one_labels', null, App::getLocale()), true) as $key => $value)
                                ...
                                <li class="mb-2">
                                    <a href="{{ $widget_one_links }}"
                                        class="fs-13 text-dark animate-underline-primary">
                                        {{ $value }}
                                    </a>
                                </li>
                            @endforeach
            ...
            <div class="col-md-3 col-sm-6">
                <div class="text-center text-sm-left mt-3">
                    ...
                    <ul class="list-inline social colored mb-4">
                        @if (!empty(get_setting('facebook_link')))
                            <li class="list-inline-item mr-1">
                                <a href="{{ get_setting('facebook_link') }}" target="_blank" class="facebook"><i class="lab la-facebook-f"></i>
                                </a>
                            </li>
                        @endif
                        ...
                        @if (!empty(get_setting('twitter_link')))
                            <li class="list-inline-item mr-1">
                                <a href="{{ get_setting('twitter_link') }}" target="_blank" class="twitter"><i class="lab la-twitter"></i>
                                </a>
                            </li>
                        @endif
                        @if (!empty(get_setting('instagram_link')))
                            <li class="list-inline-item mr-1">
                                <a href="{{ get_setting('instagram_link') }}" target="_blank" class="instagram"><i class="lab la-instagram"></i>
                                </a>
                            </li>
                        @endif
                        @if (!empty(get_setting('youtube_link')))
                            <li class="list-inline-item mr-1">
                                <a href="{{ get_setting('youtube_link') }}" target="_blank" class="youtube"><i class="lab la-youtube"></i>
                                </a>
                            </li>
                        @endif
                        @if (!empty(get_setting('linkedin_link')))
                            <li class="list-inline-item mr-1">
                                <a href="{{ get_setting('linkedin_link') }}" target="_blank" class="linkedin"><i class="lab la-linkedin-in"></i>
                                </a>
                            </li>
                        @endif
                    </ul>
                    ...
                    <img class="img-fit pt-3" src="{{ static_asset('assets/img/Monogram (1).png') }}" alt="">
                </div>

            </div>
            <div class="list-inline pt-2">
                        @if (get_setting('payment_method_images') != null)
                            @foreach (explode(',', get_setting('payment_method_images')) as $key => $value)
                                <li class="list-inline-item mr-3">
                                    <img src="{{ uploaded_asset($value) }}" class="mw-100 h-auto"
                                        style="max-height: 100%" alt="{{ translate('payment_method') }}">
                                </li>
                            @endforeach
                        @endif
                    </div>
    ...
    <div class="d-lg-none bg-transparent">
        ...
        <div class="aiz-accordion-wrap bg-light">
            ...
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #e0e2e7 !important;">
                ...
                <div class="list-inline pt-2 ml-3">
                        @if (get_setting('payment_method_images') != null)
                            @foreach (explode(',', get_setting('payment_method_images')) as $key => $value)
                                <li class="list-inline-item mr-3">
                                    <img src="{{ uploaded_asset($value) }}" class="mw-100 h-auto"
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 d-flex align-items-center">
              <a href="https://otcommerce.com/" target="_blank" class="tooltip-wrap d-flex align-items-center me-3">
                <img src="/public/uploads/otapi-logo.4a54ec6.png" alt="otapilogo" class="otapiLogo me-2">
                <span class="custom-tooltip">Powered by OpenTrade Commerce</span>
            </a>

            <div class="text-center text-lg-start fs-14" current-verison="{{ get_setting('current_version') }}">
            ...
            <div class="col-lg-6">
                <div class="text-center text-lg-right">
                    <strong>Developed by <a href="https://zaman-it.com/"><span class="text-primary">Zaman IT</span></a></strong>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row align-items-center gutters-5">
        ...
        <div class="col" style="margin-top: -10px;">
            <a href="{{ route('home') }}"
                ...
                <div
                    style="background-color: #f73838; width: 60px; height: 60px; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center;">
                    <img src="{{ asset('public/uploads/all/mobile-nav.png') }}" alt="Home Icon" width="40"
                        height="40">
                </div>
            </a>
        </div>
